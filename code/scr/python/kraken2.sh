...
kraken2 --use-names --db /projects/luo_lab/Databases/MY_KRAKEN2_DB --threads 10 "$assemblies"/merged_cell_contigs.fa --confidence 0.5 > "$kraken"/drep/kraken2_output.txt